package com.app.quized.Adapter;
...
import com.app.quized.QuestionActivity;
import com.app.quized.R;
import com.app.quized.model.Category;
            ...
            card_category.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    if(selectedId!=-1)
                    {
                        ...
                        String names = rdo_class_selected.getText().toString();
                        if (names.equals("Beginner")){
                            Common.selectedCategory.setClassId(Integer.parseInt("6"));
                        }else if (names.equals("Intermediate")){
                            Common.selectedCategory.setClassId(Integer.parseInt("7"));

                        }else {
                            Common.selectedCategory.setClassId(Integer.parseInt("8"));
