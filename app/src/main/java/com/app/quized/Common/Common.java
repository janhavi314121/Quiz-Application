...
public class Common
{
    ...
    public static List<CurrentQuestion> answerSheetList = new ArrayList<com.app.quized.model.CurrentQuestion>();
    public static List<CurrentQuestion> answerSheetListFiltered  = new ArrayList<com.app.quized.model.CurrentQuestion>();
